...
const clefOptions = [
   { 'text': 'Sol (Violino', 'value': 'treble'},
   { 'text': 'Fa (Basso)', 'value': 'bass' },
   { 'text': 'Do (Contralto)', 'value': 'alto' },
   // { 'text': 'Percussioni', 'value': 'perc' },
]
            ...
            <Container textAlign="left">
               <Form size="tiny">
                  ...
                  <Form.Group>
                     ...
                     <Form.Input label="&nbsp;" defaultValue={this.state.time.split('/')[1]} min="2" max="16" step="2" 
